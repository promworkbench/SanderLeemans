...
public class ExperimentParameters {
	...
	public static final File baseDirectory = SystemUtils.IS_OS_LINUX
			? new File("/home/sander/Documents/svn/27 - earth movers conformance/03 - TKDE/experiments/bounds")
			: new File("/mnt/hgfs/experiments");

	private static final File outputFile = new File(baseDirectory, "results.tex");
	private static final File logOutputFile = new File(baseDirectory, "results-log.tex");
	...
	private static final int stepR = 10;
	private static final int minQ = 1;
	private static final int maxQ = 1000;
	private static final int stepQ = 10;
	...
	public ExperimentParameters() {
		...
		measures.add(new MeasureProbabilityMassCovered());
		measures.add(new MeasureNumberOfTotalOrderTraces());
		measures.add(new MeasureEMSCCC());
		measures.add(new MeasureEMSCTC());
	...
	public File getOutputDirectory() {
		return new File(baseDirectory, "5-plot");
	}
