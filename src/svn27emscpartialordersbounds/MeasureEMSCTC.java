...
public class MeasureEMSCTC implements Measure {
	...
	public String[] getMeasureLatexNames() {
		return new String[] { "$\\uparrow$", "$\\downarrow$" };
	}
	...
	public double[] compute(XLog log, StochasticNet model, Marking initialMarking, Call call, int q, int r)
		...
		EMSCParametersLogPartialUncertainModelPartialCertainDefault parameters = new EMSCParametersLogPartialUncertainModelPartialCertainDefault();
