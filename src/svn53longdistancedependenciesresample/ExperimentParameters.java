...
//		stochasticAlgorithms.add(new StochasticAlgorithmNoLdds());
//		stochasticAlgorithms.add(new StochasticAlgorithmLdd());
//		stochasticAlgorithms.add(new StochasticAlgorithmLddLogAssumption());
		stochasticAlgorithms.add(new StochasticAlgorithmNoSymNoLDD());
		stochasticAlgorithms.add(new StochasticAlgorithmLddStat());
		...
		log2abbreviation.put("bpic18 Parcel document.xes.gz", "BPIC2018-6");
