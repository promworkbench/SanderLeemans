...
public class Call {
	...
	public File getDiscoveredStochasticModelFile() {
		return new File(
				new File(parameters.getDiscoveredStochasticModelsDirectory(),
						algorithm.getAbbreviation() + "-" + stochasticAlgorithm.getAbbreviation()),
				logFile.getName() + "-" + repetition + stochasticAlgorithm.getFileExtension());
	}
	...
	public File getDiscoveredStochasticModelTimeFile() {
		return new File(
				new File(parameters.getDiscoveredStochasticModelsDirectory(),
						algorithm.getAbbreviation() + "-" + stochasticAlgorithm.getAbbreviation()),
				logFile.getName() + "-" + repetition + ".time");
	}
	...
	public static void setError(File file, String s) {
		PrintWriter writer;
		try {
