...
public class Call {
	...
	public File getTransformedLogFile() {
		return new File(parameters.getTransformedLogDirectory(), logFile.getName() + "-transformed.xes.gz");
	}
	...
	public File getFlattenedModelFile() {
		return new File(parameters.getFlattenedModelsDirectory(),
				getName1() + "-" + getAlgorithm().getFlattenedFileExtension());
	}
