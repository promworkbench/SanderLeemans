...
public class svn41pcaCall {

	private String logFileName;
	private svn41pcaExperimentParameters parameters;
	private int numberOfSamples;
	private int sampleSize;
	private Attribute attribute;

	public svn41pcaCall(String logFileName, int numberOfSamples, int sampleSize,
			svn41pcaExperimentParameters parameters, Attribute attribute) {
	...
	public File getResultsFile() {
		return new File(parameters.getResultsDirectory(), "pca-samsen-" + base() + ".csv");
	}
