...
import org.processmining.stochasticawareconformancechecking.plugins.GainEntropyPlugin;

import nl.tue.astar.AStarException;

public class MeasureEntropyGain implements Measure {
	...
	public double[] compute(XLog log, StochasticNet model, Marking initialMarking, Call call)
		...
		Pair<Double, Double> r = GainEntropyPlugin.compute(log, model, new ProMCanceller() {
